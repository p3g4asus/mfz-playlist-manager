...
def main():
    ...
    parser.add_argument('--mediaset-profiledir', required=False, default='/tmp/chrome-profile')
    parser.add_argument('--mediaset-getsmil', required=False, default='playwright')
