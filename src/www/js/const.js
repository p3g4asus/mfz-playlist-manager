...
const CMD_PING = 'ping';
const PING_STATUS = 'send_status_with_ping';
const PING_STATUS_CONS = '__c';
const PING_DELAY = '__d';
...
const CMD_REMOTEPLAY_PING = 'remoteping';
const CMD_REMOTEPLAY_ID = '__id';
const CMD_LS = 'ls';
...
const PLAYLIST_SCHED_AT_THE_END_OF_FIRST_VIDEO = 4;
...
function format_duration(secs) {
    if ((secs = parseInt(secs)) < 0) secs = 0;
